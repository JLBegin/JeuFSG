...
"")
        ...
        self.buttonBackToMenu = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.buttonBackToMenu.sizePolicy().hasHeightForWidth())
        self.buttonBackToMenu.setSizePolicy(sizePolicy)
        self.buttonBackToMenu.setMinimumSize(QtCore.QSize(70, 70))
        self.buttonBackToMenu.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("interface/fig/leftArrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonBackToMenu.setIcon(icon)
        self.buttonBackToMenu.setIconSize(QtCore.QSize(35, 35))
        self.buttonBackToMenu.setObjectName("buttonBackToMenu")
        self.horizontalLayout_4.addWidget(self.buttonBackToMenu)
